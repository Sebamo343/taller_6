...
<head>
  ...
  <!--description-->
  <meta name="description" content="Formulario de inicio de seccion">
  <!--keywords-->
...
<div class="container">
  ...
  <form>
    ...
    <img class="mb-4" src="img/r.png" alt="index" width="125">
    ...
    <p class="mt-3 mb-3 text-muted"> Todos los Derechos Reservados Index
      © <%=displayDate()%>
    </p>
